...
import static net.assentindia.edi.processor.reader.plugin.Plugin.CURRENT;
...
import net.assentindia.edi.processor.reader.ansi.LoopContext;
import net.assentindia.edi.processor.reader.ansi.LoopDescriptor;
import net.assentindia.edi.processor.reader.ansi.LoopStack;
 ...
 *
 * @see net.assentindia.edi.processor.reader.plugin.berryworks.edireader.Plugin
 * @see net.assentindia.edi.processor.reader.ansi.berryworks.edireader.plugin.LoopDescriptor
 */
public class PluginControllerImpl extends PluginController {
     ...
     * @throws net.assentindia.edi.processor.reader.exception.berryworks.edireader.EDISyntaxException Description of the Exception
     */
    @Override
