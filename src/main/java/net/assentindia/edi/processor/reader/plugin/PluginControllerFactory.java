...
import net.assentindia.edi.processor.reader.abstracts.AbstractPluginControllerFactory;
...
public class PluginControllerFactory extends AbstractPluginControllerFactory {
    ...
    public static final String DEFAULT_EDIREADER_PLUGIN_PACKAGE = "net.assentindia.edi.processor.reader.ansi";
    ...
    protected Plugin getInstance(String standard, String docType) throws Exception {
        ...
        logger.info("attempting to load a plugin named {}", pluginName);
