...
import net.assentindia.edi.processor.reader.abstracts.AbstractTokenizer;
...
public class EDITokenizer extends AbstractTokenizer {
    ...
    public EDITokenizer(Reader source) {
        ...
        logger.info("Constructed a new EDITokenizer");
    }
...
//            return result;
    ...
    public char[] lookahead(int n) throws IOException {
        logger.info("EDITokenizer.lookahead({})", n);
        ...
        if (charBuffer.remaining() < n - 1) {
            logger.info("Buffering more data to satisfy lookahead({}})", n);
