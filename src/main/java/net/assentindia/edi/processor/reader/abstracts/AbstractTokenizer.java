...
package net.assentindia.edi.processor.reader.abstracts;
...
import net.assentindia.edi.processor.reader.ErrorMessages;
import net.assentindia.edi.processor.reader.Token;
import net.assentindia.edi.processor.reader.TokenImpl;
...
public abstract class AbstractTokenizer implements Tokenizer, ErrorMessages {
     ...
     * @throws IOException                                 for problem reading EDI data
     * @throws net.assentindia.edi.processor.reader.exception.berryworks.edireader.EDISyntaxException if contains non-digits
     *                                                     if empty
     */
     ...
     * @throws IOException                                 for problem reading EDI data
     * @throws net.assentindia.edi.processor.reader.exception.berryworks.edireader.EDISyntaxException if invalid EDI is detected
     */
     ...
     * @throws net.assentindia.edi.processor.reader.exception.berryworks.edireader.EDISyntaxException specific syntax error in parsed EDI data
     */
